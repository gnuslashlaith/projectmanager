    ...
    return(
        <>
            ...
            <div class="task-priority-orange">
                ...
                <button class="read-button" onClick={() => setReadOnly("PriorityOrangeOne", true)}>Save</button>
                <button class="read-button" onClick={() => setReadOnly("PriorityOrangeOne", false)}>Edit</button>
            ...
            <div class="task-priority-blue">
                <textarea placeholder="What's the next step to milestone 2?" name="PriorityBlueOne" value={goalText.PriorityBlueOne.value} readOnly={goalText.PriorityBlueOne.readOnly} onChange={handleTextChange}/>
                    <button class="read-button"onClick={() => setReadOnly("PriorityBlueOne", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueOne", false)}>Edit</button>
                <br></br>
                ...
                <div class="buttons">
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueTwo", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueTwo", false)}>Edit</button>
                </div>
                <br></br>
                ...
                <div class="buttons">
                    ...
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueThree", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueThree", false)}>Edit</button>
                </div>
            </div>
            ...
            <div class="task-priority-orange">
                ...
                <button class="read-button" onClick={() => setReadOnly("PriorityOrangeTwo", true)}>Save</button>
                <button class="read-button" onClick={() => setReadOnly("PriorityOrangeTwo", false)}>Edit</button>
            </div>
            <br></br>
            ...
            <div class="task-priority-blue">
                ...
                <div class="buttons">
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueFour", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueFour", false)}>Edit</button>
                </div>
                <br></br>
                ...
                <div class="buttons">
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueFive", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueFive", false)}>Edit</button>
                </div>
                <br></br>
                ...
                <div class="buttons">
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueSix", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityBlueSix", false)}>Edit</button>
                </div>
            </div>
            <br></br>
            ...
            <div class="task-priority-orange">
                <textarea placeholder="You made it! how do you know your project is done?"name="PriorityOrangeThree" value={goalText.PriorityOrangeThree.value} readOnly={goalText.PriorityOrangeThree.readOnly} onChange={handleTextChange}/>
                    <button class="read-button" onClick={() => setReadOnly("PriorityOrangeThree", true)}>Save</button>
                    <button class="read-button" onClick={() => setReadOnly("PriorityOrangeThree", false)}>Edit</button>
            </div>
